...
export default function Home() {
  ...
  return (
    <View className="flex-1 mt-2.5 ml-4 mr-5" style={{ paddingTop: headerHeight }} >
      <Text style={{color: Colors.black}} className="text-[30px] font-extrabold ">Explore the beautiful world!</Text>
      <View className="flex-row my-5 items-center">
        ...
        <TouchableOpacity className="bg-primaryColor p-3 rounded-xl ml-3" onPress={()=>{}}>
          <Ionicons style={{color: Colors.white}} name='options' size={28}/>
        </TouchableOpacity>
      </View>
